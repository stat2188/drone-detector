 ...
 *
 * Memory: All lookup tables in Flash (EDA_FLASH_CONST)
 * Performance: O(1) lookup via direct array indexing
 */
...
// RGB888 to RGB565 Converter (constexpr)
...
struct ThreatColorLUT {
     ...
     */
    static constexpr uint16_t COLORS[ColorConstants::THREAT_LEVEL_COUNT] EDA_FLASH_CONST = {
...
static constexpr CardStyle CARD_STYLES[ColorConstants::CARD_STYLE_COUNT] EDA_FLASH_CONST = {
...
struct DroneColorLUT {
     ...
     */
    static constexpr uint16_t COLORS[ColorConstants::DRONE_TYPE_COUNT] EDA_FLASH_CONST = {
        ...
        ColorConverter::rgb888_to_rgb565(0xFF00FF),   // Cyan - DJI_MINI (4)
        ColorConverter::rgb888_to_rgb565(0x00FFFF),   // Magenta - PARROT_ANAFI (5)
        ColorConverter::rgb888_to_rgb565(0x0000FF),   // Blue - PARROT_BEBOP (6)
...
struct UnifiedStringLookup {
     ...
     */
    static constexpr const char* const THREAT_NAMES[ColorConstants::THREAT_LEVEL_COUNT] EDA_FLASH_CONST = {
        "NONE",       // NONE (0)
        "LOW",        // LOW (1)
        "MEDIUM",     // MEDIUM (2)
        "HIGH",       // HIGH (3)
     ...
     */
    static constexpr const char* const DRONE_TYPE_NAMES[ColorConstants::DRONE_TYPE_COUNT] EDA_FLASH_CONST = {
        "Unknown",        // UNKNOWN (0)
        "DJI Mavic",      // MAVIC (1)
        "DJI P34",        // DJI_P34 (2)
     ...
     */
    static constexpr char THREAT_SYMBOLS[ColorConstants::THREAT_LEVEL_COUNT] EDA_FLASH_CONST = {
        '-',  // NONE (0)
        'i',  // LOW (1)
        '!',  // MEDIUM (2)
        '?',  // HIGH (3)
