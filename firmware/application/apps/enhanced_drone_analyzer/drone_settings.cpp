...
DroneSettingsView::DroneSettingsView(NavigationView& nav, const ScanConfig& config, DroneScanner* scanner_ptr, DroneDisplay* display) noexcept
    ...
    , check_confirm_count_({UI_POS_X(1), UI_POS_Y(13)}, 4, "Con", false)
    , field_confirm_count_({UI_POS_X(6), UI_POS_Y(13)}, 2, {1, 20}, 1, ' ')
    , check_noise_blacklist_({UI_POS_X(1), UI_POS_Y(15)}, 8, "Blklist", false)
    , check_spectrum_detection_({UI_POS_X(20), UI_POS_Y(12)}, 4, "Mar", false)
    , check_neighbor_margin_({UI_POS_X(10), UI_POS_Y(4)}, 4, "Nbm", false)
    , field_neighbor_margin_({UI_POS_X(15), UI_POS_Y(4)}, 2, {0, 15}, 1, ' ')
    , check_rssi_variance_({UI_POS_X(10), UI_POS_Y(11)}, 5, "RVar", false)
