...
DroneSettingsView::DroneSettingsView(NavigationView& nav, const ScanConfig& config, DroneScanner* scanner_ptr, DroneDisplay* display) noexcept
    ...
    , check_spectrum_detection_({UI_POS_X(20), UI_POS_Y(5)}, 4, "Mar", false)
    , check_neighbor_margin_({UI_POS_X(10), UI_POS_Y(9)}, 3, "NB", false)
    , field_neighbor_margin_({UI_POS_X(14), UI_POS_Y(9)}, 2, {0, 15}, 1, ' ')
