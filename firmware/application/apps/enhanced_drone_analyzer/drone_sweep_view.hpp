...
public:
    ...
    static ui::Labels labels_;
    static ui::NumberField field_sw1_start_;
    static ui::NumberField field_sw1_end_;
    static ui::NumberField field_sw1_step_;

    static ui::Labels labels_sw2_;
    static ui::Checkbox check_sw2_enabled_;
    static ui::NumberField field_sw2_start_;
    static ui::NumberField field_sw2_end_;
    static ui::NumberField field_sw2_step_;

    // Exception fields — right side of Window 1 (5 slots)
    static ui::Labels labels_exc1_;
    static ui::NumberField field_sw1_exc0_;
    static ui::NumberField field_sw1_exc1_;
    static ui::NumberField field_sw1_exc2_;
    static ui::NumberField field_sw1_exc3_;
    static ui::NumberField field_sw1_exc4_;

    // Exception fields — right side of Window 2 (5 slots)
    static ui::Labels labels_exc2_;
    static ui::NumberField field_sw2_exc0_;
    static ui::NumberField field_sw2_exc1_;
    static ui::NumberField field_sw2_exc2_;
    static ui::NumberField field_sw2_exc3_;
    static ui::NumberField field_sw2_exc4_;
};
