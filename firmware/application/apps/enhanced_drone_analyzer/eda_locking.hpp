...
public:
     ...
     * @note Critical section does NOT extend through construction to avoid priority inversion
     */
     ...
     * @note Critical section does NOT extend through destruction to avoid priority inversion
     */
     ...
     * @note No critical section needed - volatile bool reads are atomic on ARM Cortex-M
     */
    T* get() noexcept {
...
public:
    /**
     * @brief Minimum free stack bytes required
     * @note Typical values: UI paint() methods: 1024-2048 bytes, Signal processing: 512-1024 bytes
     */
...
private:
     ...
     * @note Returns 0 if called from main thread
     */
