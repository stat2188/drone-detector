...
void DroneAnalyzerSettingsManager::reset_to_defaults(ui::external_app::enhanced_drone_analyzer::DroneAnalyzerSettings& settings) {
...
bool DroneAnalyzerSettingsManager::parse_line(const std::string& line, ui::external_app::enhanced_drone_analyzer::DroneAnalyzerSettings& settings) {
...
bool DroneAnalyzerSettingsManager::load_settings(ui::external_app::enhanced_drone_analyzer::DroneAnalyzerSettings& settings) {
    reset_to_defaults(settings);
    return true;
}

bool DroneAnalyzerSettingsManager::save_settings(const ui::external_app::enhanced_drone_analyzer::DroneAnalyzerSettings& settings) {
    (void)settings;
    return false;
}
